...
{        
    ...
    private $_host = "dpg-ctfjm20gph6c73fn9ja0-a.oregon-postgres.render.com";
    private $_username = "postgresql";
    private $_password = "EWqkKLNRDDw7t3xml33xvwIWVFn1yDo4";
    private $_database = "emirdb";
